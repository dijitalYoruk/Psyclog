...
class TherapistWalletPage extends StatefulWidget {
  @override
  _TherapistWalletPageState createState() => _TherapistWalletPageState();
}

class _TherapistWalletPageState extends State<TherapistWalletPage> {
